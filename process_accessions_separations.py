...
import re
from text_to_parquet import load_lookup_tables, create_denormalized_records
...
def process_fy_data(df, extract_dir, dataset_key, data_type):
    ...
    lookups = load_lookup_tables(extract_dir, dataset_key)
...
def process_accessions_separations_zip(zip_path):
    ...
    try:
        ...
        with zipfile.ZipFile(zip_path, 'r') as zf:
            ...
            if 'March_2025' in main_data_file:
                ...
                denormalized_df = process_fy_data(df, extract_dir, dataset_key, data_type)
...
def process_all_accessions_separations():
    ...
    for i, zip_path in enumerate(zip_files, 1):
        ...
        result = process_accessions_separations_zip(zip_path)
        if result:
