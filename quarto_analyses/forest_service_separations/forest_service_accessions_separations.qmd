---
title: "Forest Service Accessions and Separations Analysis"
author: "Abigail Haddad"
date: today
format:
  html:
    output-file: forest_service_accessions_separations.html
    toc: true
    toc-depth: 3
    code-fold: true
...
if not monthly_combined.empty:
    ...
    if not complete_years.empty:
        ...
        ax.set_title('Forest Service Annual Accessions, Separations, and Net Change (Complete Years Only)', fontsize=14, fontweight='bold')
